...
const FloatingGeo    = dynamic(() => import('@/app/components/canvas/FloatingGeo'),    { ssr: false });
const WorldMap       = dynamic(() => import('@/app/components/canvas/WorldMap'),       { ssr: false });
const FlowLines      = dynamic(() => import('@/app/components/canvas/FlowLines'),      { ssr: false });
const MorphGlobe     = dynamic(() => import('@/app/components/canvas/MorphGlobe'),     { ssr: false });
const ProductCoverflow = dynamic(() => import('@/app/components/ProductCoverflow'),     { ssr: false });
