...
export default function Nav() {
  ...
  const a = (href) => pathname === href ? 'active' : '';
      ...
      <nav className="nav-wrap" aria-label="Main navigation">
        ...
        <div className={`nav-pill${scrolled ? ' scrolled' : ''}`}>
          ...
          <Link className="nav-brand" href="/">
            {/* Wordmark sits alongside, so the emblem is decorative */}
            <Image className="nav-mark" src="/images/logo-mark.png" alt="" width={26} height={26} priority />
            <b>Gosarvam Global</b>
          </Link>
