...
// item     { slug, name, tag, desc, img, video?, grad }
// fromRect DOMRect of the card that was clicked — the overlay animates out of it
// onClose  () => void

export default function CinematicOverlay({ item, fromRect, onClose }) {
