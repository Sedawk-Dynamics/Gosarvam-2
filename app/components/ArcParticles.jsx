...
// Particle { x, y, vx, vy, alpha, decay, r, color }
// Wave     { x, y, radius, alpha, color, width }
// Flare    { x, y, alpha, r, color }
// Imperative handle exposes: burst(x, y, glowRgb)

const ArcParticles = forwardRef((_, ref) => {
